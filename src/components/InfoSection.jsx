...
function InfoSection() {
  return (
    <div>
        <section>
        <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8 mt-10 md:mt-24">
            <div className="grid grid-cols-1 gap-4 md:grid-cols-4 md:items-center md:gap-8">
            <div className="md:col-span-3">
                <img src="https://images.unsplash.com/photo-1763016940383-3be9417637a4?q=80&w=1630&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" className="rounded-3xl w-full h-auto object-cover" alt="" />
            </div>
